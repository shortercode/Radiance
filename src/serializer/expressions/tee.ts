...
export function write_tee_variable_expression(ctx: FunctionContext, node: WASTExpressionNode, write_expression: WriteExpression) {
	const { is_global, id, source, name, value_type, value } = node as WASTSetVarNode;
