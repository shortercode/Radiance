...
export function write_less_than_equals_expression(ctx: FunctionContext, node: WASTExpressionNode, write_expression: WriteExpression) {
	...
	switch (inner_type.wasm_type()) {
		...
		ctx.writer.writeUint8(Opcode.i32_le_u);
		break;
		case PrimativeTypes.u64:
		ctx.writer.writeUint8(Opcode.i64_le_u);
		break;
		default:
