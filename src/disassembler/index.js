...
function readBlockType(byteReader) {
    switch (byteReader.readUint8()) {
        case 0x7F: return "i32";
        case 0x7E: return "i64";
        case 0x7D: return "f32";
...
function readMemarg(byteReader) {
    return [byteReader.readUVint(), byteReader.readUVint()];
}
function readName(byteReader) {
...
class ConditionalInstruction extends Instruction {
    constructor(type, primary, secondary) {
        super("if");
        this.type = type;
...
function readNumericInstruction(opcode, byteReader) {
    opcode -= 0x45;
...
function readVariableInstruction(opcode, byteReader) {
    const id = byteReader.readUVint();
...
function readInstruction(byteReader) {
